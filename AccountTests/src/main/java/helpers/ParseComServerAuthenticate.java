    ...
    public String userSignUp(String name, String email, String pass, String authType) throws Exception {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() != 201) {
                ParseComError error = null;//new Gson().fromJson(responseString, ParseComError.class);
                throw new Exception("Error creating user["+error.code+"] - " + error.error);
            }


            User createdUser = null;//new Gson().fromJson(responseString, User.class);
...
//        httpGet.getParams().setParameter("username", user).setParameter("password", pass);
        ...
        try {
            ...
            User loggedUser = null;//new Gson().fromJson(responseString, User.class);
